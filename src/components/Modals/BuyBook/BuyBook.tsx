                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-2">
                      <p className="text-md text-gray-500">
                        თუკი გსურს ამ წიგნის შეძენა, ჩარიცხე შესაბამისი თანხა
                        ქვემოთ მოცემულ ანგარიშის ნომერზე, შემდეგ მოცემულ ველში
                        შეიყვანე ბარათის მფლობელის სახელი და გვარი და მხოლოდ
                        ამის შემდეგ დააჭირე ვარდისფერ ღილაკს „გადავიხადე“.
                        დაელოდე რამდენიმე საათი (მაქს. 24) და წიგნი
                        გაგიაქტიურდება.
                      </p>
                    </div>
                    <div className="my-5">
