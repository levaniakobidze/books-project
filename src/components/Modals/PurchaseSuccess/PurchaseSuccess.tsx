...
const PurchaseSuccess = () => {
  ...
  return (
    <Transition.Root show={showPurchaseSuccessModal} as={Fragment}>
      <Dialog
        as="div"
        className="relative z-10"
        onClose={setShowPurchaseSuccessModal}>
        <Transition.Child
          as={Fragment}
              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-gradient-to-r to-tl from-[#c7d8e8] to-[#fde6e7] px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
                <div>
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-2">
                      <p className="my-2 text-md font-bold leading-5">
                        {" "}
                        წიგნი დაემატა თქვენს ბიბლიოთეკაში.
                      </p>
